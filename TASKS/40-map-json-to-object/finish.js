...
const secondPostsJSON = postsJSON.map(element => JSON.parse(element))

console.log(secondPostsJSON)
console.log(secondPostsJSON[1].postId)
console.log(secondPostsJSON[secondPostsJSON.length - 1].commentsQuantity)